        ...
        <Card className="border-white/10 bg-background/60 backdrop-blur-xl shadow-2xl shadow-indigo-500/10">
          ...
          <CardContent className="pt-6">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <Button
                type="submit"
                className="w-full h-11 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-medium rounded-lg shadow-lg shadow-indigo-500/25 transition-all"
